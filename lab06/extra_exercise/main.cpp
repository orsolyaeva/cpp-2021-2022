...
//    cout << customer1;
    ...
    bank.getCustomer(1).newAccount(0);
    bank.getCustomer(1).newAccount(1000);
    bank.getCustomer(2).newAccount(3453);
    bank.getCustomer(2).newAccount(3566);
    bank.getCustomer(3).newAccount(342);
    bank.getCustomer(3).newAccount(700);
